    ...
    if (model.calendarType == GSCalendarType.jalali) {
      return (selectedEndDate == null && selectedStartDate == null)
          ...
          : DateDataRangeModel(
              ...
              startTimeStamp:
                  selectedStartDate!.toDateTime().microsecondsSinceEpoch,
              endTimeStamp:
                  selectedEndDate!.toDateTime().microsecondsSinceEpoch,
      ...
      return (selectedGregorianEndDate == null &&
          ...
          : DateDataRangeModel(
              ...
              startTimeStamp:
                  selectedGregorianStartDate!.microsecondsSinceEpoch,
...
class _GSDateRangePickerFieldState extends State<GSDateRangePickerField> {
  ...
  _initialGregorianDates() {
    if (widget.model.initialDate == null) {
      ...
      gregorianInitialDate = DateTime(widget.model.initialDate!.year,
    ...
    if (widget.model.availableTo == null) {
      ...
      gregorianAvailableTo = DateTime(widget.model.availableTo!.year,
  ...
  _initialJalaliDates() {
    if (widget.model.initialDate == null) {
      ...
      jalaliInitialDate = Jalali(widget.model.initialDate!.year,
          widget.model.initialDate!.month, widget.model.initialDate!.day);
    }
    ...
    if (widget.model.availableTo == null) {
      ...
      jalaliAvailableTo = Jalali(widget.model.availableTo!.year,
          widget.model.availableTo!.month, widget.model.availableTo!.day);
    }
  ...
  _initialGregorianAvailableFromDate() {
    if (widget.model.isPastAvailable ?? false) {
      if (widget.model.availableFrom != null) {
        gregorianAvailableFrom = DateTime(widget.model.availableFrom!.year,
  ...
  _initialJalaliAvailableFromDate() {
    if (widget.model.isPastAvailable ?? false) {
      if (widget.model.availableFrom != null) {
        jalaliAvailableFrom = Jalali(widget.model.availableFrom!.year,
            widget.model.availableFrom!.month, widget.model.availableFrom!.day);
      } else {
